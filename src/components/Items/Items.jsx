    ...
    switch (opcion) {
      ...
      case "Precio, menor a mayor":
        array.sort((a, b) => {
          ...
          if (!a.hasOwnProperty("precio") && !b.hasOwnProperty("precio"))
            return 0;
  ...
  useEffect(() => {
    if (products.length === 0) {
      ...
      const toyProducts = products.filter(
        (product) =>
          product.categoria === "articulos" && product.disponibilidad === true
      );
      ...
      <section className="clothes__asideYMain">
        <aside className="clothes__asideYMain__aside">
          ...
          {showSize ? (
            ...
            >
              {age.map((item, index) =>
                filter.some(
                  (obj) => obj.name === "edad" && obj.items.includes(item)
                ) ? (
                  <div
                    className="clothes__asideYMain__aside__options__option"
                    key={index}
                  >
                    <div
                      onClick={() => toogleSelectFilter("edad", item)}
                      style={{
                        backgroundColor: "#FA897B",
                      }}
                    ></div>
                  ...
                  <div
                    ...
                    key={index}
                  >
                    <div onClick={() => toogleSelectFilter("edad", item)}></div>
                    <p>{item}</p>
                  </div>
                )
              )}
          ...
          {showText && (
            <span className="text-description-state">
              {" "}
              Indica la calidad física del producto, calificada en una escala
              del 1 al 10. Donde 10 es la mejor calidad.
            </span>
          )}
          <div
            className="clothes__asideYMain__aside__filter"
            onMouseOver={handleHover}
            onMouseOut={noHandleHover}
          >
            <p>Estado</p>
            <i>
              <img
        ...
        {showFilterFlex ? (
          <section className="clothes__asideYMain__asideMobile">
            ...
            {showState && (
              <span className="text-description-state-mobile">
                Indica la calidad física del producto, calificada en una escala
                del 1 al 10. Donde 10 es la mejor calidad.
              </span>
            )}
        ...
        <main className="clothes__asideYMain__main">
          ...
          <section
            ...
            style={{
              display: "flex",
              justifyContent: `${
                productsFiltered.length ? "flex-start" : "center"
              }`,
            }}
          >
