  ...
  return (
      <section className="profile">
          <figure className="d-flex justify-content-center mt-0 mb-2 flex-column align-items-center">
              <img
                  src={photo ? URL.createObjectURL(photo) : avatarImg}
                  alt="profile"
              />
          ...
          <Form className="details">
              <InputGroup className="justify-content-center mb-3">
                  ...
                  />
                  <Button
                      className="btn-edit rounded-pill rounded-start"
                      onClick={() => canEdit("name")}
                  >
